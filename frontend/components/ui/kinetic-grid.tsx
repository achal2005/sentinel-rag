...
export default function KineticGrid({
  ...
  const draw = useCallback(
    (now: number) => {
      ...
      // Themed to the Sentinel indigo/violet system (default) so the grid
      // reads as one surface with the rest of the app.
      const theme = {
        default: {
          bg: "#0b0b1a",
          lineActive: { r: 129, g: 140, b: 248, a: 0.9 }, // indigo #818cf8
          nodeActive: { r: 167, g: 139, b: 250, a: 1.0 }, // violet #a78bfa
          glow: "129,140,248",
          ripple: "34,211,238", // cyan #22d3ee
        },
        monochrome: {
          bg: "#000000",
  ...
  useEffect(() => {
    ...
    // Respect reduced-motion: render one static grid, skip the rAF loop and
    // the cursor-warp / click-ripple interactions entirely.
  ...
  return (
    <div
      className={cn(
        ...
        globalColor === "monochrome" ? "bg-[#000000]" : "bg-[#0b0b1a]",
        className,
      )}
    >
      <canvas
